...
/*   Updated: 2023/03/06 14:53:11 by ycardona         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_count_ops(int i, t_list *current, t_list **list_a, t_list **list_b);
int		ft_count_ops_small(int pos_b, t_list *current, t_list **list_a, t_list **list_b);
